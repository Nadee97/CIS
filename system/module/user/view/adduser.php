...
$min = Date("Y-m-d", $pptid);
     ...
     $fun_id=2;
       ...
       $nouserfun=$resultuserfun->num_rows;
           ...
           if($nouserfun==0) { 
             header("location:../../login/view/dashboard.php");
             }
        ...
        <div id="main">
            ...
            &nbsp;  <div id="navi">      <!-- breadcrumb -->
                <ol class="breadcrumb">
                    ...
                    &nbsp;</div>
            <div id="content">
                <h2 style="text-align:center; margin-top:10px">  Add User</h2> 
          
                <div class="container">

                    <div class="row">
                        <div  id="error_msg" class="col-md-12" style="text-align: center">
                                <?php
                                if (isset($_REQUEST['msg'])) {
                                    $msg = base64_decode($_REQUEST['msg']);
                                    ?>
                                    <span class=" alert-danger"><?php echo $msg; ?></span>
                ...
                <form method="post" 
                      action="../controller/usercontroller.php?status=Add"
                    ...
                    <div class="container">
                        ...
                        <div class="row">                       
                            ...
                            <div class="col-md-3">
                                <input type="text" name="user_f_name"  id="user_f_name" placeholder="First Name" 
                                       class="form-control" />
                            </div> 
                            ...
                            <div class="col-md-3">
                                <input type="text" name="user_l_name"  id="user_l_name" placeholder="Last Name" 
                                       class="form-control" />
                            </div> 
                        </div> 
                        <div class="row">
                        ...
                        <div class="row">                       
                            ...
                            <div class="col-md-3">
                                <input type="text" name="user_email"  id="user_email" placeholder="Email Addresss" 
                            ...
                            <div class="col-md-3">
                                <select name="role_id" id="role_id" class="form-control" 
                                    ...
                                    while ($rowrole = $resultrole->fetch_assoc()) {
                                        echo "<option value=" . $rowrole['role_id'] . ">" . $rowrole['role_name'] .
                                        "</option>";
                                    }
                                    ?>       
                                </select>
